...
export default function Seagulls(props: JSX.IntrinsicElements['group']) {
  const group = useRef<THREE.Group|null>(null);
  const { nodes, materials, animations } = useGLTF("/models/seagulls.glb")as unknown as {
    nodes: {
    ...
    materials: {
      ...
      Seagull_m: THREE.MeshStandardMaterial
    }
